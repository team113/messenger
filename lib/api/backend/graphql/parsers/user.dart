...
BlacklistCursor fromGraphQLBlacklistCursorToDartBlacklistCursor(String v) => BlacklistCursor(v);
String fromDartBlacklistCursorToGraphQLBlacklistCursor(BlacklistCursor v) => v.toString();
List<BlacklistCursor> fromGraphQLListBlacklistCursorToDartListBlacklistCursor(
    List<Object?> v) =>
    v.map((e) => fromGraphQLBlacklistCursorToDartBlacklistCursor(e as String)).toList();
...
fromGraphQLListNullableBlacklistCursorToDartListNullableBlacklistCursor(
    List<Object?>? v) =>
    v
        ?.map((e) => fromGraphQLBlacklistCursorToDartBlacklistCursor(e as String))
        .toList();
List<String>? fromDartListNullableBlacklistCursorToGraphQLListNullableBlacklistCursor(
    List<BlacklistCursor>? v) =>
    v?.map((e) => fromDartBlacklistCursorToGraphQLBlacklistCursor(e)).toList();

BlacklistCursor? fromGraphQLBlacklistCursorNullableToDartBlacklistCursorNullable(
    String? v) =>
...
fromGraphQLListBlacklistCursorNullableToDartListBlacklistCursorNullable(
    List<Object?> v) =>
    v
        .map((e) => fromGraphQLBlacklistCursorNullableToDartBlacklistCursorNullable(
        e as String?))
        .toList();
List<String?> fromDartListBlacklistCursorNullableToGraphQLListBlacklistCursorNullable(
    List<BlacklistCursor?> v) =>
    v
        .map((e) => fromDartBlacklistCursorNullableToGraphQLBlacklistCursorNullable(e))
        .toList();
List<BlacklistCursor?>?
...
fromDartListNullableBlacklistCursorNullableToGraphQLListNullableBlacklistCursorNullable(
    ...
    v
        ?.map((e) =>
        fromDartBlacklistCursorNullableToGraphQLBlacklistCursorNullable(e))
        .toList();
