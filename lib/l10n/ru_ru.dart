...
final Map<String, String> ruRU = {
  ...
  'btn_forward_messages': 'Переслать сообщения',
  ...
  'err_maximum_number_of_forwarded_items':
      'Максимальное количество пересылаемых за раз сообщений - 100.',
  ...
  'label_forward_selected': 'Выбрано',
  'label_forwarded_message': 'Пересланное сообщение',
  'label_forwarded_messages': 'Пересылаемые сообщения',
  ...
  'label_menu': 'Меню',
  'label_message_was_forwarded': 'Сообщение было переcлано',
  'label_messages_was_forwarded': 'Сообщения были переcланы',
  'label_name': 'Имя',
