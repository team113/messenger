...
final Map<String, String> ruRU = {
  ...
  'btn_add_participant_two_lines': 'Добавить\nучастника',
  ...
  'btn_call_audio_off_two_lines': 'Выключить\nмикрофон',
  'btn_call_audio_on': 'Включить микрофон',
  'btn_call_audio_on_two_lines': 'Включить\nмикрофон',
  ...
  'btn_call_end_two_lines': 'Завершить\nзвонок',
  ...
  'btn_call_switch_camera_two_lines': 'Переключить\nкамеру',
  'btn_call_toggle_speaker': 'Переключить динамик',
  'btn_call_toggle_speaker_two_lines': 'Переключить\nдинамик',
  'btn_call_video_off': 'Выключить камеру',
  'btn_call_video_off_two_lines': 'Выключить\nкамеру',
  'btn_call_video_on': 'Включить камеру',
  'btn_call_video_on_two_lines': 'Включить\nкамеру',
