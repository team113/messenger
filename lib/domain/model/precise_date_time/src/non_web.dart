...
class PreciseDateTime extends NewType<DateTime>
  ...
  PreciseDateTime.parse(String formattedString)
      : super(DateTime.parse(formattedString));
  ...
  /// ```
  PreciseDateTime.now() : super(DateTime.now());
  ...
  @override
  String toString() => val.toUtc().toIso8601String();
}
