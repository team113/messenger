  ...
  return Obx(() {
    ...
    return _padding(
      FieldButton(
        ...
        style: style.titleMedium.copyWith(color: style.colors.primary),
      ),
    );
  });
}
            ...
            text: TextSpan(
              children: [
                TextSpan(
                  ...
                  style:
                      style.labelSmall.copyWith(color: style.colors.secondary),
                ),
                TextSpan(
                  text: 'label_nobody'.l10n.toLowerCase() + 'dot'.l10n,
                  style: style.labelSmall.copyWith(color: style.colors.primary),
                  recognizer: TapGestureRecognizer()
                    ..onTap = () async {
      ...
      widgets.addAll([
        Theme(
          ...
          child: FieldButton(
            ...
            style: style.titleMedium.copyWith(color: style.colors.secondary),
          ),
        ),
      ]);
      widgets.add(const SizedBox(height: 10));
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text(text, style: style.bodyLarge),
              ),
            ],
          ),
        ),
...
Future<void> _deleteEmail(
  ...
  final bool? result = await MessagePopup.alert(
    ...
    description: [
      ...
      TextSpan(text: email.val, style: style.labelLarge),
...
Future<void> _deletePhone(
  ...
  final bool? result = await MessagePopup.alert(
    ...
    description: [
      ...
      TextSpan(text: phone.val, style: style.labelLarge),
