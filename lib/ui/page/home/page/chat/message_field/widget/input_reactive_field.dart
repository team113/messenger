...
/// Custom-styled [ReactiveTextField] with elements for composing and sending.
class InputReactiveField extends StatelessWidget {
  const InputReactiveField({
    super.key,
    required this.state,
    this.fieldKey,
    this.sendKey,
    ...
    this.onTrailingLongPressed,
    this.isForwarding = false,
  });

  /// [Key] of a [ReactiveTextField] this [InputReactiveField] has.
  final Key? fieldKey;

  /// [Key] of a send button this [InputReactiveField] has.
  final Key? sendKey;
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            GestureDetector(
              onLongPress: onTrailingLongPressed,
              child: WidgetButton(
