          ...
          () => UserSearchBar(
            ...
            body: c.contactsReady.value
                ? c.favorites.isEmpty && c.contacts.isEmpty
                    ? Center(child: Text('label_no_contacts'.t()))
                          ...
                          children: [
                            if (c.favorites.isNotEmpty) ...[
                              Padding(
                                ...
                                child: Text('label_favorite_contacts'.t()),
                              ),
                              ...c.favorites.entries
  ...
  Widget _contact(ChatContact contact, ContactsTabController c) =>
      ContextMenuRegion(
        ...
        menu: ContextMenu(
          actions: [
            ContextMenuButton(
              label: 'btn_change_contact_name'.t(),
              onPressed: () {
            ...
            ContextMenuButton(
              label: 'btn_delete_from_contacts'.t(),
