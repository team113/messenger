...
class FundsMoreView extends StatelessWidget {
  const FundsMoreView({super.key});

  /// Displays a [ChatsMoreView] wrapped in a [ModalPopup].
  static Future<T?> show<T>(BuildContext context) {
    return ModalPopup.show(context: context, child: const FundsMoreView());
  }

  @override
  Widget build(BuildContext context) {
    return GetBuilder(
      key: const Key('FundsMoreView'),
      init: FundsMoreController(Get.find()),
      builder: (FundsMoreController c) {
        return Column(
            ...
            Flexible(
              child: ListView(
                ...
                children: [
                  ...
                  _header(context, 'label_display_transactions'.l10n),
  ...
  Widget _balance(BuildContext context, FundsMoreController c) {
    return Obx(() {
      return Stack(
  ...
  Widget _transactions(BuildContext context, FundsMoreController c) {
    return Obx(() {
      return Stack(
        alignment: Alignment.centerRight,
        children: [
