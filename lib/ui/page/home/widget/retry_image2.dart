...
class RetryImage2 extends StatefulWidget {
  const RetryImage2(this.url, {Key? key}) : super(key: key);

  final String url;

  @override
  State<RetryImage2> createState() => _RetryImage2State();
}

class _RetryImage2State extends State<RetryImage2> {
