...
class LoginController extends GetxController {
  ...
  Future<void> check() async {
    ...
    if (login.text.isEmpty) {
      login.error.value = 'err_input_empty'.td;
      return;
    }
    ...
    try {
      ...
      if (!exists) {
        login.error.value = 'err_account_not_found'.td;
      }
  ...
  Future<void> signIn() async {
    ...
    if (password.text.isEmpty) {
      password.error.value = 'err_input_empty'.td;
      return;
    }
    ...
    try {
      ...
      password.error.value = 'err_incorrect_password'.td;
  ...
  Future<void> recoverAccess() async {
    ...
    if (recovery.text.isEmpty) {
      ...
      recovery.error.value = 'err_input_empty'.td;
      return;
    }
    ...
    try {
      ...
      recovery.error.value = 'err_incorrect_input'.td;
    } on ArgumentError {
      recovery.error.value = 'err_incorrect_input'.td;
  ...
  Future<void> validateCode() async {
    ...
    if (recoveryCode.text.isEmpty) {
      ...
      recoveryCode.error.value = 'err_input_empty'.td;
      return;
    }
    ...
    try {
      ...
      recoveryCode.error.value = 'err_incorrect_input'.td;
    } on ArgumentError {
      recoveryCode.error.value = 'err_incorrect_input'.td;
  ...
  Future<void> resetUserPassword() async {
    ...
    if (newPassword.text.isEmpty) {
      newPassword.error.value = 'err_input_empty'.td;
    ...
    if (repeatPassword.text.isEmpty) {
      repeatPassword.error.value = 'err_input_empty'.td;
      return;
    }
    ...
    try {
      ...
      newPassword.error.value = 'err_incorrect_input'.td;
      return;
    }
    ...
    try {
      ...
      repeatPassword.error.value = 'err_incorrect_input'.td;
      return;
    }
    ...
    try {
      ...
      MessagePopup.success('label_password_was_changed'.td);
