...
import '/ui/page/home/widget/wallet.dart';
        ...
        final List<Widget> children = [
                ...
                trailing: [
                  ...
                  AnimatedButton(
                    onPressed: () => c.icon.value =
                        IconDetails.svg(SvgIcons.callStart, invert: true),
                    child: Container(
                      height: 32,
                      width: 32,
                      decoration: BoxDecoration(
            ...
            children: [
              _navBar(
                ...
                [
                  AnimatedButton(
                    onPressed: () =>
                        c.icon.value = IconDetails.svg(SvgIcons.walletClosed),
                  ...
                  AnimatedButton(
                    onPressed: () =>
                        c.icon.value = IconDetails.svg(SvgIcons.wallet),
                    child: const WalletWidget(
                      balance: 1000,
                      visible: true,
                    ),
                  ...
                  AnimatedButton(
                    onPressed: () =>
                        c.icon.value = IconDetails.svg(SvgIcons.walletOpened),
                    child: const WalletWidget(
                      balance: 1000,
                      visible: false,
                    ),
          ...
          Block(
            children: [
              ...
              ActionButton(
                trailing: AnimatedButton(
                  onPressed: () =>
                      c.icon.value = IconDetails.svg(SvgIcons.muted16),
                  child: const SvgIcon(SvgIcons.muted16),
                ),
              ),
              const SizedBox(height: 8),
              ActionButton(
                trailing: AnimatedButton(
                  onPressed: () =>
                      c.icon.value = IconDetails.svg(SvgIcons.unmuted16),
                  child: const SvgIcon(SvgIcons.unmuted16),
                ),
              ),
              const SizedBox(height: 8),
              ActionButton(
                            ...
                            if (trailing != null)
                              SizedBox(
                                ...
                                child: Center(
                                    child: AnimatedButton(
                                  onPressed: () =>
                                      c.icon.value = IconDetails.svg(trailing!),
          ...
          Block(
            children: [
              AnimatedButton(
                onPressed: () => c.icon.value =
                    IconDetails.svg(SvgIcons.handUpBig, invert: true),
          ...
          children: [
            ...
            Positioned(
              ...
              child: Obx(() {
                ...
                final String download = data?.asset ??
