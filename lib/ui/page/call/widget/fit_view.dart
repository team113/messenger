...
class CreateColumnWidget extends StatelessWidget {
  final int mColumns;
  final int rowIndex;
...
class CreateRowsWidget extends StatelessWidget {
  final int mColumns;
  ...
  Widget build(BuildContext context) {
    ...
    for (int rowIndex = 0; rowIndex < rowCount; rowIndex++) {
      final List<Widget> column = CreateColumnWidget(
        mColumns: mColumns,
        rowIndex: rowIndex,
        dividerSize: dividerSize,
        children: children,
