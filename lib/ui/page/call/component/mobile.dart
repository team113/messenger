...
class MobileCall extends StatelessWidget {
  const MobileCall(this.call, {super.key});
                ...
                Obx(() {
                  if (c.isDialog &&
                    ...
                    return FloatingFit<Participant>(
                      ...
                      onManipulated: (bool m) =>
                          c.secondaryManipulated.value = m,
                      itemBuilder: (e) {
                        return Stack(
                          children: [
                        ...
                        return ContextMenuRegion(
                          actions: [
                            ...
                            if (e.member.id != c.me.id) ...[
                              if (e.video.value?.direction.value.isEmitting ??
                                  false)
                                ContextMenuButton(
                              ...
                              if (e.audio.value?.direction.value.isEmitting ??
                                  false)
                                ContextMenuButton(
                                  label: (e.audio.value?.direction.value
                                              .isEnabled ==
                                          true)
                              ...
                              if (e.member.isRedialing.isFalse)
                                ContextMenuButton(
                                  ...
                                  onPressed: () => c
                                      .removeChatCallMember(e.member.id.userId),
                                ),
                            ] else ...[
                              ContextMenuButton(
                  ...
                  children: [
                    ...
                    Obx(() {
                      ...
                      if (isDialog) {
                        ...
                        return CallCoverWidget(c.chat.value?.callCover,
                            user: user);
                      } else {
                                  ...
                                  child: Obx(() {
                                    bool withDots = c.state.value !=
                                        ...
                                        (c.state.value ==
                                            ...
                                            isOutgoing);
                                    bool isDialog =
                                        c.chat.value?.chat.value.isDialog ==
                                            true;
              ...
              SafeArea(
                child: Obx(() {
                  ...
                  return AnimatedSlider(
                    ...
                    isOpen: showUi,
                    beginOffset:
                        Offset(0, -190 - MediaQuery.of(context).padding.top),
                    child: Align(
