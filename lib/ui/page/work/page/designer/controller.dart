...
/// Controller of the [WorkTab.designer] section of [Routes.work] page.
class DesignerWorkController extends GetxController {
  DesignerWorkController(this._authService);
  ...
  static final ChatMessageText _welcome =
      ChatMessageText('label_welcome_message_vacancy'.l10n);
