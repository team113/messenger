...
class VideoPlaybackKit extends StatefulWidget {
  const VideoPlaybackKit(
    this.url, {
    super.key,
    this.checksum,
    this.onController,
  ...
  @override
  State<VideoPlaybackKit> createState() => _VideoPlaybackState();
}

/// State of a [VideoPlayback] used to initialize and dispose video controller.
class _VideoPlaybackState extends State<VideoPlaybackKit> {
  ...
  @override
  void didUpdateWidget(VideoPlaybackKit oldWidget) {
