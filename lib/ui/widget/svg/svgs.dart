...
class SvgIcons {
  ...
  static const SvgData mute16 = SvgData(
    'assets/icons/mute.svg',
    width: 17.85,
    height: 16,
  );

  static const SvgData unmute16 = SvgData(
  ...
  static const SvgData pinOutlinedWhite = SvgData(
    'assets/icons/pin_outlined_white.svg',
    width: 13.74,
    height: 19,
  );
  ...
  static const SvgData unpinOutlinedWhite = SvgData(
    'assets/icons/unpin_outlined_white.svg',
    width: 13.74,
    height: 19.73,
  );
  ...
  static const SvgData menuSettings = SvgData(
    'assets/icons/menu_settings.svg',
    width: 32,
    height: 32,
  );

  static const SvgData menuBalance = SvgData(
    'assets/icons/menu_balance.svg',
    width: 32,
    height: 32,
  );
  ...
  static const SvgData coinWhite = SvgData(
    'assets/icons/coin_white.svg',
    width: 19,
    height: 19,
  );
  ...
  static const SvgData chatsTinyWhite = SvgData(
    'assets/icons/chats_tiny_white.svg',
    width: 10.18,
    height: 11,
  );
  ...
  static const SvgData callsTinyWhite = SvgData(
