...
extension KeyboardKeyToStringExtension on PhysicalKeyboardKey {
  ...
  static final Map<PhysicalKeyboardKey, String> labels =
      <PhysicalKeyboardKey, String>{
        ...
        PhysicalKeyboardKey.enter: PlatformUtils.isMacOS ? '↩︎' : 'Enter',
        PhysicalKeyboardKey.escape: PlatformUtils.isMacOS ? 'esc' : 'Escape',
        PhysicalKeyboardKey.backspace: PlatformUtils.isMacOS
            ? '⌫'
            : 'Backspace',
        PhysicalKeyboardKey.tab: PlatformUtils.isMacOS ? '⇥' : 'Tab',
        PhysicalKeyboardKey.space: PlatformUtils.isMacOS ? '␣' : 'Space',
        ...
        PhysicalKeyboardKey.capsLock: PlatformUtils.isMacOS ? '⇪' : 'Caps Lock',
        ...
        PhysicalKeyboardKey.home: PlatformUtils.isMacOS ? '↖' : 'Home',
        PhysicalKeyboardKey.pageUp: PlatformUtils.isMacOS ? '⇞' : 'Page Up',
        PhysicalKeyboardKey.delete: PlatformUtils.isMacOS ? '⌫' : 'Delete',
        PhysicalKeyboardKey.end: PlatformUtils.isMacOS ? '↘' : 'End',
        PhysicalKeyboardKey.pageDown: PlatformUtils.isMacOS ? '⇟' : 'Page Down',
        PhysicalKeyboardKey.arrowRight: '→',
        PhysicalKeyboardKey.arrowLeft: '←',
        PhysicalKeyboardKey.arrowDown: '↓',
        PhysicalKeyboardKey.arrowUp: '↑',
        PhysicalKeyboardKey.controlLeft: PlatformUtils.isMacOS ? '⌃' : 'Ctrl',
        PhysicalKeyboardKey.shiftLeft: PlatformUtils.isMacOS ? '⇧' : 'Shift',
        PhysicalKeyboardKey.altLeft: PlatformUtils.isMacOS ? '⌥' : 'Alt',
        PhysicalKeyboardKey.metaLeft: PlatformUtils.isMacOS ? '⌘' : '⊞',
        PhysicalKeyboardKey.controlRight: PlatformUtils.isMacOS ? '⌃' : 'Ctrl',
        PhysicalKeyboardKey.shiftRight: PlatformUtils.isMacOS ? '⇧' : 'Shift',
