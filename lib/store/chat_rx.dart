...
class HiveRxChat extends RxChat {
  ...
  late final HiveGraphQlPageProvider<DtoChatItem, ChatItemsCursor, ChatItemId>
      _provider;
  ...
  Future<void> updateChat(HiveChat newChat) async {
    ...
    if (chat.value.id != newChat.value.id) {
      ...
      final Iterable<DtoChatItem> saved = await _local.values;
  ...
  Future<MessagesPaginated> _paginateAround(
    ...
    final DtoChatItem? hiveItem = await get(item);
              ...
              case ChatEventKind.read:
                ...
                if (at != null) {
                  ...
                  if (event.byUser.id == me) {
                    ...
                    if (key != null) {
                      final DtoChatItem? item = await _local.get(key.id);
                      if (item != null) {
