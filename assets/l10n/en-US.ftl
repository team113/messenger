...
alert_contact_will_be_deleted1 = Contact{" "}
alert_contact_will_be_deleted2 = {" "}will be deleted.
...
label_message_cant_make_call_funds = Unfortunately, the call cannot be completed. Please, add funds to your account.
btn_add_funds = Add funds
label_funds_enabled = Enabled
label_funds_disabled = Disabled
label_transactions_enabled = Enabled
label_transactions_disabled = Disabled
label_display_funds = Display balance
