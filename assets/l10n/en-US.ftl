...
alert_chat_wiil_be_blocked1 = Chat{" "}
alert_chat_wiil_be_blocked2 = {" "}will be blocked.
alert_chat_wiil_be_cleared1 = Chat{" "}
alert_chat_wiil_be_cleared2 = {" "}will be cleared.
alert_chat_wiil_be_hidden1 = Chat{" "}
alert_chat_wiil_be_hidden2 = {" "}will be hidden.
alert_contact_wiil_be_removed1 = Contact{" "}
alert_contact_wiil_be_removed2 = {" "}will be removed.
alert_dialog_wiil_be_cleared1 = Dialog with user{" "}
alert_dialog_wiil_be_cleared2 = {" "}will be cleared.
alert_dialog_wiil_be_hidden1 = Dialog with user{" "}
alert_dialog_wiil_be_hidden2 = {" "}will be hidden.
...
alert_user_wiil_be_blocked1 = User{" "}
alert_user_wiil_be_blocked2 = {" "}will be blocked.
...
label_block = Block
label_blocked_user = User is blocked
