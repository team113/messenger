...
label_beneficiary_bank_address = Beneficiary bank address
label_beneficiary_bank_address_example = Bank address
label_beneficiary_bank_name = Beneficiary bank name
label_beneficiary_bank_name_example = Bank name
label_beneficiary_bank_swift_code = Beneficiary bank SWIFT-code
label_beneficiary_bank_swift_code_example = Bank SWIFT-code
label_beneficiary_data_is_required_description =
    Beneficiary data is required in order to generate corresponding financial documentation.

    The invoice is generated automatically when sending funds and is attached to the relevant transaction.
...
label_email_optional = E-mail (optional)
...
label_identification_requirements_description =
    - only a photo of the document is accepted (scanned copy is not accepted);
    - the entire identification document including edges must be visible on the photo;
    - the text on the identifying document must be readable, glares and blurs are not acceptable;
    - identifying document is a passport, residence card, ID card, drivers license.
...
label_operation_canceled = Canceled
label_operation_completed = Completed
label_operation_declined = Declined
label_operation_failed = Failed
label_operation_in_progress = In progress
label_optimism_op_mainnet = Optimism (OP Mainnet)
label_order_payment = Order your withdrawal
...
label_usdt_crypto_exchange_platform = Crypto exchange platform
...
label_usdt_tag_memo_etc = Additional payment and/or recipient identifier
label_usdt_tag_memo_etc_example = Tag, memo, identifier, comment, etc.
label_usdt_ton = USDT - TON
label_usdt_tron = USDT - TRON (TRC-20)
label_usdt_wallet_number = Wallet number
