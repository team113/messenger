...
btn_transactions = Sus transacciones
...
country_fj = Fiyi
country_fk = Islas Falkland (Malvinas)
country_fm = Micronesia
country_fo = Islas Faroe
country_fr = Francia
country_ga = Gabón
...
country_gr = Grecia
country_gs = Georgia del sur y las islas Sandwich del sur
...
country_kp = Corea (Norte)
country_kr = Corea (Sur)
country_kw = Kuwait
...
country_lv = Letonia
country_ly = Jamahiriya Arabe Libia
...
country_se = Suecia
country_sg = Singapur
country_sh = Santa Elena, Ascensión y Tristán de Acuña
...
label_account_created_description = Puede cambiar su avatar, nombre, estatus de texto, contraseña, usuario y e-mail en la configuración del perfil.
...
label_account_number_iban = Número de cuenta (IBAN)
label_account_number_iban_monobank = UA0000000000000000000000000
label_account_number_iban_sepa = 0000000000000000000
label_account_will_be_removed_from_list1 = Cuenta{" "}
...
label_beneficiary_bank_address = Dirección de banco del beneficiario
label_beneficiary_bank_address_example = Dirección de banco
label_beneficiary_bank_name = Nombre de banco del beneficiario
label_beneficiary_bank_name_example = Nombre de banco
label_beneficiary_bank_swift_code = Código SWIFT de banco del beneficiario
label_beneficiary_bank_swift_code_example = Código SWIFT de banco
label_beneficiary_data_is_required_description =
...
label_choose_country = Seleccione país
...
label_email_optional = E-mail (opcional)
...
label_for_authors = Para los autores
label_for_promoters = Para promotores
...
label_identification_requirements_description =
    - solo se aceptan fotos del documento (no se admiten escaneos);
    - debe verse el documento completo, incluyendo todos los bordes;
    - el texto del documento de identidad debe ser legible; no se permiten reflejos ni imágenes borrosas;
    - documentos válidos: pasaporte, tarjeta de residencia, cédula de identidad, licencia de conducir.
...
label_login_optional = Nombre de usuario (opcional)
...
label_n_business_days = {$n} días hábiles
label_name = Nombre
label_name_hint = Su nombre público
label_name_optional = Nombre público (opcional)
...
label_to_confirm_identity_upload_photo = Para confirmar su identidad, suba una foto de su documento de identidad.
...
label_up_to_amount_usdt = hasta {$amount} USDT
...
label_usdt_solana = USDT - Solana
label_usdt_tag_memo_etc = Identificador adicional de pago y/o del beneficiario
label_usdt_tag_memo_etc_example = Tag, memo, identificador, comentario, etc.
label_usdt_ton = USDT - TON
label_usdt_tron = USDT - TRON (TRC-20)
label_usdt_wallet_number = Número de la billetera
label_usdt_wallet_number_example = T0000000000000000
