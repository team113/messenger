...
label_delete_for_everyone = Также удалить для всех
...
label_message_will_deleted_for_you = Это сообщение будет удалено только у Вас
label_messages_will_deleted_for_you = Эти сообщения будет удалено только у Вас
