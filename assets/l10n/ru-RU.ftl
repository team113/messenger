...
btn_add_to_favorites_action = Добавить в избранные
btn_allow = Разрешить
...
btn_delete_from_favorites_action = Удалить из избранных
