...
label_add_email_confirmation_sent = На указанный Вам E-mail был отправлен код подтверждения. Код подтверждения действителен в течение 24 часов. Пожалуйста, введите его ниже.
label_add_email_confirmation_sent_again = На указанный Вам E-mail повторно отправлен код подтверждения. Код подтверждения действителен в течение 24 часов. Пожалуйста, введите его ниже.
err_incorrect_phone = Некорректный номер телефона
label_recovery_code_sent = Проверочный код отправлен в соответствии с контактной информацией данного аккаунта. Пожалуйста, введите его ниже.
