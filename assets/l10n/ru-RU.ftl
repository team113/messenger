...
btn_remove_account = Удалить аккаунт
btn_reply = Ответить
...
err_incorrect_link_input = Ссылка должна содержать только буквы, цифры, а также символы "-" и "_".
err_incorrect_link_too_long = Ссылка не может содержать более 100 символов
...
label_chat_created_by_link = Диалог создан по прямой ссылке
...
label_group_profile = Профиль группы
...
label_user_profile = Профиль пользователя
