...
alert_chat_wiil_be_blocked1 = Чат{" "}
alert_chat_wiil_be_blocked2 = {" "}будет заблокирован.
alert_chat_wiil_be_cleared1 = Чат{" "}
alert_chat_wiil_be_cleared2 = {" "}будет очищен.
alert_chat_wiil_be_hidden1 = Чат{" "}
alert_chat_wiil_be_hidden2 = {" "}будет скрыт.
alert_contact_wiil_be_removed1 = Контакт{" "}
alert_contact_wiil_be_removed2 = {" "}будет удалён.
alert_dialog_wiil_be_cleared1 = Диалог с пользователем{" "}
alert_dialog_wiil_be_cleared2 = {" "}будет очищен.
alert_dialog_wiil_be_hidden1 = Диалог с пользователем{" "}
alert_dialog_wiil_be_hidden2 = {" "}будет скрыт.
...
alert_user_wiil_be_blocked1 = Пользователь{" "}
alert_user_wiil_be_blocked2 = {" "}будет заблокирован.
...
label_blocked_user = Пользователь заблокирован
...
label_remove_from_contacts = Удалить из контактов
