...
label_avatar_removed = Аватар удалён
label_avatar_updated = Аватар обновлён
label_away = отошёл
...
label_name_removed = Имя группы удалено
label_name_updated = Имя группы изменено на {$name}
