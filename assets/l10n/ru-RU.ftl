...
label_files_downloaded = Файлы загружены
label_files_saved_to_gallery = Файлы загружены в галерею
...
label_select_chats = Выберите чаты
label_select_contacts = Выберите контакты
