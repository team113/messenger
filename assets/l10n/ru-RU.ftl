...
err_no_space_left_in_gallery = Отсутствует свободное место на устройстве. Пожалуйста, почистите хранилище и попробуйте снова.
...
err_too_many_phones = Был достигнут максимум номеров телефона.
...
label_chat_monolog_subtitle = Напиши себе
label_chat_name_hint = Название чата
label_chats = Чаты
label_chats_section_hint = Кнопки аудио- и видеозвонка
...
label_display_audio_and_video_call_buttons = Отображать Кнопки аудио- и видеозвонка
...
label_legal_info = Юридическая информация
btn_legal_info = Юридическая информация
btn_legal_info_description = Условия использования, политика конфиденциальности
...
label_guest_account_created = Одноразовый аккаунт создан
label_online = онлайн
...
label_recover_account_description = Укажите Ваш E-mail или номер телефона.
...
label_select_chats = Выбор чатов
label_select_contacts = Выбор контактов
...
label_your_direct_link_section = Прямая ссылка, QR код
btn_personalize = Персонализация
label_personalization = Персонализация
...
space_or_space = {" "}или{" "}
space_vertical_space = {" "}|{" "}
label_delete_contact = Удалить контакта
label_delete_contacts = Удалить контактов
label_delete_chats = Удалить чаты
label_delete_chat = Удалить чат
alert_chat_will_be_deleted1 = Чат{" "}
alert_chat_will_be_deleted2 = {" "}будет удалён.
...
label_transactions_enabled = Включено
...
label_fee_per_incoming_call_minute = Входящий звонок, за минуту
...
btn_set_price = Принимать оплату
...
btn_mute_chats = Отключить звук
btn_unmute_chats = Включить звук
btn_display_transactions = Показать транзакции
btn_hide_transactions = Скрыть транзакции
btn_display_balance = Показать баланс
btn_hide_balance = Скрыть баланс
label_leave_group_call_when_alone = Завершать групповой звонок автоматически, когда остаётся только один участник (Вы)
label_don_t_leave_group_call_when_alone = Не завершать групповой звонок после выхода всех, кроме Вас
label_open_calls_in = Отображать звонки
...
label_scan_qr_code = Сканировать QR код
...
label_show_less = Скрыть
label_participants = Участников: {$count}
label_media_buttons_position = Кнопки аудио- и видеозвонка
label_devices_section = Устройства и сканирование QR кода
label_add_edit_delete = Добавить, редактировать, удалить
label_get_paid_for_incoming_title = Принимать оплату
label_get_paid_for_incoming_description = За входящие сообщения и звонки
label_show_sections = Показывать разделы
label_configure_navigation_panel = Панели навигации
label_publics = Паблики
label_balance = Баланс
btn_mute_all_chats = Выключить звук чатов
btn_unmute_all_chats = Включить звук чатов
btn_mute_all_publics = Выключить звук пабликов
btn_unmute_all_publics = Включить звук чатов
btn_show_balance_tab = Показать раздел баланса
btn_hide_balance_tab = Скрыть раздел баланса
btn_show_work_tab = Показать раздел работы
...
label_payment_price_for_messages_and_calls_to_user = Установлена плата ¤ 50 за отправку сообщения и ¤ 150/мин за совершение звонка пользователю {$name}.
...
label_swift_transfer_description = Для пополнения счёта с помощью банковского перевода (SWIFT), пожалуйста, укажите имя или название отправителя платежа, полный адрес (улица, номер дома и/или квартиры, город, почтовый индекс, штат/регион/область, страна), e-mail, а также сумму и валюту платежа. На основании указанных данных Вам в чат и по электронной почте будет отправлена проформа-инвойс с данными, необходимыми для отправки платежа.
label_sepa_transfer_description = Для пополнения счёта с помощью банковского перевода (SEPA), пожалуйста, укажите имя или название отправителя платежа, полный адрес (улица, номер дома и/или квартиры, город, почтовый индекс, штат/регион/область, страна), e-mail, а также сумму и валюту платежа. На основании указанных данных Вам в чат и по электронной почте будет отправлена проформа-инвойс с данными, необходимыми для отправки платежа.
label_order_payment = Заказать выплату
