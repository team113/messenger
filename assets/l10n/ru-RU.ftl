...
btn_copy_text_short = Скопировать
...
label_email_confirmation_code_was_sent =
    Код подтверждения был отправлен на указанный E-mail.
...
label_photo = Фото
label_presence_title = Присутствие (светофор)
...
label_add_email_confirmation_sent = На указанный Вами E-mail был отправлен код подтверждения. Код подтверждения действителен в течение 24 часов. Пожалуйста, введите его ниже.
label_add_email_confirmation_sent_again = На указанный Вами E-mail повторно отправлен код подтверждения. Код подтверждения действителен в течение 24 часов. Пожалуйста, введите его ниже.
