...
label_account_created_description = Вы можете изменить свой аватар, имя, текстовый статус, пароль, логин и e-mail в настройках профиля.
...
label_account_number_iban = Номер счёта (IBAN)
...
label_beneficiary_bank_address = Адрес банка получателя
label_beneficiary_bank_address_example = Адрес банка
label_beneficiary_bank_name = Название банка получателя
label_beneficiary_bank_name_example = Название банка
label_beneficiary_bank_swift_code = SWIFT-код банка получателя
label_beneficiary_bank_swift_code_example = SWIFT-код банка
...
label_device_settings = Настройки устройства
...
label_email_optional = E-mail (опционально)
...
label_identification_requirements_description =
    - принимаются только фото документа (скан-копия не принимается);
    - на фото должен быть чётко виден документ, удостоверяющий личность, полностью и с краями;
    - текст документа, удостоверяющего личность, должен быть хорошо читаем, не допускается присутствие бликов и размытий;
...
label_n_business_days = {$n} рабочих дней
label_name = Имя
label_name_hint = Ваше публичное имя
label_name_optional = Публичное имя (опционально)
...
label_password_optional = Пароль (опционально)
...
label_processing_time = Время обработки
...
label_repeat_password_optional = Повторить пароль (опционально)
...
label_text_status_description = Максимум 33 символов
label_text_status_hint = Текстовый статус. Макс. 33 символов.
label_thats_easy = Это просто
label_this_device = Это устройство
label_this_withdrawal_option_is_not_available_in_country = Данный вариант вывода средств недоступен в выбранной стране.
label_to_confirm_identity_upload_photo = Для подтверждения личности, загрузите фото Вашего документа, удостоверяющего личность.
...
label_up_to_amount_usdt = до {$amount} USDT
...
label_usdt_tag_memo_etc = Дополнительный идентификатор платежа и/или получателя
label_usdt_tag_memo_etc_example = Тэг, memo, идентификатор и т.д.
label_usdt_ton = USDT - TON
label_usdt_tron = USDT - TRON (TRC-20)
label_usdt_wallet_number = Номер кошелька
