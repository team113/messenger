...
enum WidgetKey {
  ...
  ChatsButton,
  ChatsTab,
  ConfirmLogoutPasswordField,
  ConfirmLogoutRepeatPasswordField,
  ConfirmLogoutSavePasswordButton,
  ConfirmLogoutSetPasswordButton,
  ConfirmLogoutView_alert,
  ConfirmLogoutView_password,
  ConfirmLogoutView_success,
  CloseButton,
  ContactsButton,
  ContactsTab,
