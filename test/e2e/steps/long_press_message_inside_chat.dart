...
/// Long press message inside specified chat.
///
/// Examples:
/// - I long press "Hello, Alice!" message inside "Bob" chat
/// - I long press "Hello, Alice!" message inside "Charlie" chat
final StepDefinitionGeneric longPressMessageInsideChat =
    and2<String, String, CustomWorld>(
  'I long press {string} message inside {string} chat',
  (String msg, String chatName, context) async {
    ...
    if (chat != null) {
      ...
      messageId ??= chatItemHiveProvider.messages
          ...
          .id;
      if (messageId != null) {
        Finder find = context.world.appDriver
            .findByKeySkipOffstage(Key('Message_$messageId'));
        await context.world.appDriver.nativeDriver.longPress(find);
      }
    }
