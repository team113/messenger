...
///
/// Examples:
/// - Then I wait until `WidgetKey` in list is absent
/// - Then I wait until `WidgetKey` in list is present
final StepDefinitionGeneric waitUntilKeyExistsInList =
    then2<WidgetKey, Existence, FlutterWorld>(
  'I wait until {key} in list is {existence}',
