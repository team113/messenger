...
void main() async {
  ...
  final chatProvider = Get.put(ChatHiveProvider(), permanent: true);
  await chatProvider.init();
  await chatProvider.clear();
  final credentialsProvider =
      Get.put(CredentialsHiveProvider(), permanent: true);
  await credentialsProvider.init();
  final draftProvider = Get.put(DraftHiveProvider(), permanent: true);
